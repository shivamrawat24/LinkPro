...
Tryo ( this folder contains self experiments in application building ....)
Balance the Account ( this application is about a user login file where if user forget password, then user can click on "forget password" and gets an otp for login ...).
